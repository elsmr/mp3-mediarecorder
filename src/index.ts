...
export const getMediaRecorderClass = (wasmURL: string): typeof MediaRecorder => {
    class Mp3MediaRecorder extends EventTarget implements MediaRecorder {
        ...
        constructor(stream: MediaStream) {
            ...
            this.worker.postMessage(new InitMessage({ wasmURL }));
        ...
        start(): void {
            ...
            this.worker.postMessage(
                new StartRecordingMessage({ config: { sampleRate: this.audioContext.sampleRate } })
            );
        }
